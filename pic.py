...
class car_pic():
    def __init__(self, middlepath):
        self.photo_path = middlepath
        self.op = 0
        self.starttimes = 5
        self.sleeptime = 1
        self.order_number = 0
...
CLASSES = ('__background__',  # always index 0
           'red zhuan', 'green zhuan', 'blue zhuan', 'yellow zhuan', 'yangleduo', 'xuebi', 'xuehua', 'shuangwaiwai',
           'gangsiqiu', 'wangqiu', 'yumaoqiu', 'apple')
NETS = {'vgg16': ('VGG16',
